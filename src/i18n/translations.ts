...
export const translations = {
  es: {
    ...
    dashboard: {
      ...
      fundamentalLabel: "Frecuencia fundamental",
      stationLabel: "Estación",
      stationName: "Tomsk, Rusia",
      stateCalm: "Calmo",
      stateActive: "Activo",
      stateElevated: "Elevado",
      stateStorm: "Tormenta",
      spectrogramTitle: "Espectrograma del día",
      spectrogramSubtitle: "Frecuencia (0–40 Hz) vs. tiempo · el color indica amplitud",
      spectrogramHowTo: "¿Cómo leer este gráfico?",
      activityChartTitle: "Actividad histórica",
      activityChartSubtitle: "Nivel de actividad diario de la Resonancia Schumann",
      range7d: "7 días",
      range30d: "30 días",
      chartEmpty: "Aún no hay suficientes datos históricos.",
      reportTitle: "Informe del día",
      reportSubtitle: "Interpretación editorial de la lectura de hoy",
      learnTitle: "Aprende",
      learnSubtitle: "Qué es la Resonancia Schumann y cómo leer sus gráficos",
      historyTitle: "Histórico",
      faqTitle: "Preguntas frecuentes",
      faq1q: "¿Qué es la Resonancia Schumann?",
      faq1a: "Es un conjunto de frecuencias electromagnéticas naturales que resuenan en la cavidad entre la superficie de la Tierra y la ionosfera, generadas principalmente por la actividad de los rayos. Su frecuencia fundamental es de aproximadamente 7.83 Hz.",
      faq2q: "¿Cada cuánto se actualizan los datos?",
      faq2a: "Las lecturas se sincronizan varias veces al día a partir de los datos públicos de la estación de monitoreo de Tomsk (Rusia). La hora de la última actualización aparece en la parte superior de la página.",
      faq3q: "¿La Resonancia Schumann afecta a las personas?",
      faq3a: "No existe evidencia científica concluyente de efectos directos en la salud. Algunas personas reportan cambios en el sueño, el ánimo o la energía durante días de alta actividad, pero estas asociaciones no están clínicamente comprobadas. Nuestra interpretación diaria es orientativa.",
      faq4q: "¿Qué significan los niveles Baja, Media, Alta y Muy alta?",
      faq4a: "Son una clasificación editorial de la intensidad (amplitud) observada en el espectrograma del día: cuanto más brillante y extensa es la señal, mayor el nivel de actividad asignado.",
      faq5q: "¿De dónde vienen los datos?",
      faq5a: "Del Space Observing System de la Universidad de Tomsk (Rusia), una de las estaciones de monitoreo de la Resonancia Schumann con datos públicos más utilizadas del mundo.",
    },
    // 404 Page
    notFound: {
      title: "404",
  ...
  en: {
    ...
    dashboard: {
      ...
      fundamentalLabel: "Fundamental frequency",
      stationLabel: "Station",
      stationName: "Tomsk, Russia",
      stateCalm: "Calm",
      stateActive: "Active",
      stateElevated: "Elevated",
      stateStorm: "Storm",
      spectrogramTitle: "Today's spectrogram",
      spectrogramSubtitle: "Frequency (0–40 Hz) vs. time · color indicates amplitude",
      spectrogramHowTo: "How to read this graph?",
      activityChartTitle: "Historical activity",
      activityChartSubtitle: "Daily Schumann Resonance activity level",
      range7d: "7 days",
      range30d: "30 days",
      chartEmpty: "Not enough historical data yet.",
      reportTitle: "Daily report",
      reportSubtitle: "Editorial interpretation of today's reading",
      learnTitle: "Learn",
      learnSubtitle: "What the Schumann Resonance is and how to read its graphs",
      historyTitle: "History",
      faqTitle: "Frequently asked questions",
      faq1q: "What is the Schumann Resonance?",
      faq1a: "It is a set of natural electromagnetic frequencies resonating in the cavity between Earth's surface and the ionosphere, generated mainly by lightning activity. Its fundamental frequency is approximately 7.83 Hz.",
      faq2q: "How often is the data updated?",
      faq2a: "Readings are synced several times a day from the public data of the Tomsk (Russia) monitoring station. The last update time is shown at the top of the page.",
      faq3q: "Does the Schumann Resonance affect people?",
      faq3a: "There is no conclusive scientific evidence of direct health effects. Some people report changes in sleep, mood, or energy on high-activity days, but these associations are not clinically proven. Our daily interpretation is indicative only.",
      faq4q: "What do the Low, Medium, High and Very High levels mean?",
      faq4a: "They are an editorial classification of the intensity (amplitude) observed in the day's spectrogram: the brighter and more extensive the signal, the higher the assigned activity level.",
      faq5q: "Where does the data come from?",
      faq5a: "From the Space Observing System at Tomsk University (Russia), one of the most widely used public Schumann Resonance monitoring stations in the world.",
    },
    // 404 Page
    notFound: {
      title: "404",
